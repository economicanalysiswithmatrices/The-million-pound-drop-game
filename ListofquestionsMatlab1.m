...
%question
%%Round5
Q1R5={'Which was the book written by Zoroaster?','A:The Declaration','B:A Thousand Splendid Suns','C:Avesta','C'}
Q2R5={'A short-sighted person uses spectacles fitted with _?','A:Concave lenses','B:Convex lenses','C:Coverging lens','C'}
Q3R5={'What is the science of colors?','A:Chromatics','B:Aromatics','C:Radiation','A'}
Q4R5={'Which force done by the system will increase the potential energy of the system?','A:A conservative Force''B:Air resistance','C:Pull force','A'}
Q5R5={'Who invented the microwave?','A:Dr. Percy Lebaron Spencer','B:Dr Issac Newton','C:Einstein','A:'}
Q6R5={'The atmosphere is held to the earth by _?','A:Gravity','B:The Sky','C:The Moon','A'}
Q7R5={'The band width of fringes is independent of what?','A:The Number of Fringes','B:The Order of Fringes','C:The Colour of Fringes','B'}
Q8R5={'What is the function of ‘Tendril’ in plants?','A:Growing','B:Climbing','C:Photosynthesis','B'}
Q9R5={'What is the phenomenon that makes light to propagate through optical fibre?','A:Gamma Radiation','B:Infrared Radiation','C:A:Total Internal Reflection','C'}
Q10R5={'What is the best type of grain used in brewing beer?','A:Wheat','B:Barley','C:Oats','B'}
Q11R5={'What species of fish are also known as kippers?','A:Salmon','B:Cod','C:Herring','C'}
Q12R5={'Name the French region famed for making claret','A:Vienna','B:Bordeaux','C:Paris','B'}
Q13R5={'How many British monarchs have there been since 1900?','A:Six','B:Seven','C:Eight','A'}
Q14R5={'The Scottish Grand National is held at which racecourse?','A:Sandown','B:Ayr','C:Epsom Downs','B'}
Q15R5={'Harlequin loved which pantomime character?','A:Aladdin','B:Columbine','C:Robinson Crusoe','B'}
Q16R5={'What is scampi made from?','A:Prawns','B:Chickens','C:Fish','A'}
Q17R5={'In place of milk, what is added to Russian tea?','A:Orange Zest','B:Slice of Lemon','C:Rose water','B'}
Q18R5={'What distinctive feature does a Man cat have?','A:It has no tail','B:It has no stripes','C:It has no whiskers','A'}
Q19R5={'Name the poet whose love was like a red, red rose','A:Robert "Robbie" Burns','B:Shakespeare','C:Wilfred Owen','A'}
Q20R5={'The national holiday of Waitangi Day is held in which country?','A:Australia','B:New Zealand','C:Austria','B'}
Q21R5={'What name was given to the soldiers who protected Roman emperors?','A:Praetorian Guard.','B:Soliders','C:The White Knights','A'}
Q22R5={'Which two metals is pewter made from?','A:Tin and Lead','B:Copper and Lead','C:Tin and Copper','A'}
Q23R5={'What was Louis Armstrongs chosen form of music?','A:Classical','B:House','C:Jazz','C'}
Q24R5={'Name the port of Rome','A:Milan','B:Analipse','C:Ostia','C'}
Q25R5={'Paul Newman ate fifty eggs in which film?','A:The Sting','B:Cool Hand Luke','C:The Colour of Money','B'}
%%Round6
Q1R6={'Don Alfonso is the lead role in which opera?','A:Cosi Fan Tutte by Mozart','B:The Magic Flute','C:The Music of the Night','A'}
...
%For Round7 each question is written in the form of the array with the 
%question in the first column, then 2 options, A B, are in the columns 
%2-3,respectively and the last column is the right answer for each question
%question
%%Round7
